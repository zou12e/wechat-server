...
INSERT INTO `huiyanbang`.`audio` (`title`, `author`, `audioAuthor`, `content`, `time`, `url`, `type`,`createTime`,`updateTime`, `status`)VALUES ('人和人的区别', '来自网络', '吴静', '其实人和人到最后的区别，就是这一个又一个的坎儿，能熬过去，你就不一样了，可能连你自己都预料不到，在那些负重前行的日子里，能激发出自身多大的潜能来，但是你要坚信，你所付出的努力总有一天，命运会偷偷奖励你，你吃过的苦，受过的难，流过的泪，最终都会变成一束光，带你抵达你想去的地方，这一路风雨兼程，那个拼命想要打好一手烂牌的好孩子，才更值得被岁月温柔以待。', '54', 'https://www.zourunze.com/static/wechat/audio/5.m4a', '5',now(), now(),'1');
...
INSERT INTO `huiyanbang`.`audio` (`title`, `author`, `audioAuthor`, `content`, `time`, `url`, `type`,`createTime`,`updateTime`, `status`)VALUES ('大概人这一生', '来自网络', '吴静', '大概人这一生，总会遇见这样一个人，他曾让你对明天充满期待，确没有出现在你的明天里，也正是因为这样，才会有这世间，罪难逃避命运的感慨。如果我一辈子没有结婚的念头，那我终生不嫁，这是我的选择，而不是我的失败。以前总觉得，人生最美好的就是相遇，后来才懂得，最难得的其实是重逢，因为到那时候，你刚好成熟，我恰好温柔，就像李宗盛在歌里唱到的那样，我从来不想独身，确预感晚婚，我在等，世上为一契合的灵魂。', '57', 'https://www.zourunze.com/static/wechat/audio/8.m4a', '8',now(), now(),'1');
